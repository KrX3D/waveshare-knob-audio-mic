...
# Declare as both Component and Speaker so it can be referenced wherever a
# speaker::Speaker is expected (mixer output_speaker, media_player, voice_assistant).
...
CONFIG_SCHEMA = cv.Schema(
    {
        ...
        # 48000 Hz default when used with media_player/TTS pipelines.
        # The hardware reconfigures per WAV header for SD file playback.
